...
const Videos = () => {
  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack width={'full'} marginTop={'20'}  > 
      <video
          controls
        ...
        ></video>
        <VStack alignItems={'flex-start'} overflowY={'auto'} p={'8'} width={'full'}>
          <Heading fontSize={'15'}>
            Video 1
          </Heading>
          <Text>
            Description : this video is illegal.
          </Text>
        </VStack>
        </VStack>
       <VStack alignItems={'stretch'} width={['full','xl']} overflowY={'auto'} p="8"
        spacing={'8'} marginTop={'20'}>
